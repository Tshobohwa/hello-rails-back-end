...
- Use the following Commands:
  `git clone  https://github.com/Tshobohwa/hello-rails-back-end.git `
...
Feel free to check the [issues page](https://github.com/Tshobohwa/hello-rails-back-end/issues)
